...
export const STREAMS_SAFE_COLUMNS = 'id, seller_id, title, description, category, tags, status, thumbnail_url, viewer_count, peak_viewers, engagement_score, avg_watch_time_seconds, total_reactions, scheduled_at, started_at, ended_at, city, community_id, mux_stream_id, mux_playback_id, mux_asset_id, created_at, livekit_room_name, recording_url'
