...
const content = {
  en: {
    ...
    buyerFaq: [
      ...
      { q: 'Can I return an item?', a: 'Yes! You have 14 days from delivery to request a return, in accordance with Israeli Consumer Protection Law. Items must be in their original condition. Contact the seller through the app to initiate a return.' },
      { q: 'How long does shipping take?', a: 'Shipping times depend on the seller. Most sellers in Israel ship within 1-3 business days. Estimated delivery time is displayed before purchase.' },
    ...
    sellerFaq: [
      ...
      { q: 'What are the seller fees?', a: 'ShaPop charges a small commission on completed sales. The exact rate depends on your seller tier. New sellers start at a competitive introductory rate. Check your Seller Dashboard for details.' },
      { q: 'When do I get paid?', a: 'Payouts are processed weekly (every Sunday) to your registered bank account. There\'s a minimum payout threshold of 50 ILS.' },
    ...
    generalFaq: [
      { q: 'Is ShaPop available outside Israel?', a: 'Currently, ShaPop is focused on the Israeli market. We plan to expand to additional countries in the future.' },
      ...
      { q: 'Is ShaPop free to use?', a: 'Yes! The app is free to download and use. Buyers pay no fees. Sellers pay a small commission only on completed sales.' },
    ] as FaqItem[],
  },
  he: {
    title: '\u05DE\u05E8\u05DB\u05D6 \u05E2\u05D6\u05E8\u05D4',
    ...
    buyerFaq: [
      ...
      { q: '\u05D0\u05E4\u05E9\u05E8 \u05DC\u05D4\u05D7\u05D6\u05D9\u05E8 \u05DE\u05D5\u05E6\u05E8?', a: '\u05DB\u05DF! \u05D9\u05E9 14 \u05D9\u05D5\u05DD \u05DE\u05D4\u05DE\u05E9\u05DC\u05D5\u05D7 \u05DC\u05D1\u05E7\u05E9 \u05D4\u05D7\u05D6\u05E8\u05D4 \u05D1\u05D4\u05EA\u05D0\u05DD \u05DC\u05D7\u05D5\u05E7 \u05D4\u05D2\u05E0\u05EA \u05D4\u05E6\u05E8\u05DB\u05DF. \u05D4\u05DE\u05D5\u05E6\u05E8 \u05D7\u05D9\u05D9\u05D1 \u05DC\u05D4\u05D9\u05D5\u05EA \u05D1\u05DE\u05E6\u05D1 \u05DE\u05E7\u05D5\u05E8\u05D9.' },
      { q: '\u05DB\u05DE\u05D4 \u05D6\u05DE\u05DF \u05DC\u05D5\u05E7\u05D7 \u05DE\u05E9\u05DC\u05D5\u05D7?', a: '\u05D6\u05DE\u05E0\u05D9 \u05D4\u05DE\u05E9\u05DC\u05D5\u05D7 \u05EA\u05DC\u05D5\u05D9\u05D9\u05DD \u05D1\u05DE\u05D5\u05DB\u05E8. \u05E8\u05D5\u05D1 \u05D4\u05DE\u05D5\u05DB\u05E8\u05D9\u05DD \u05D1\u05D9\u05E9\u05E8\u05D0\u05DC \u05E9\u05D5\u05DC\u05D7\u05D9\u05DD \u05EA\u05D5\u05DA 1-3 \u05D9\u05DE\u05D9 \u05E2\u05E1\u05E7\u05D9\u05DD.' },
    ...
    sellerFaq: [
      ...
      { q: '\u05DE\u05EA\u05D9 \u05DE\u05E7\u05D1\u05DC\u05D9\u05DD \u05EA\u05E9\u05DC\u05D5\u05DD?', a: '\u05EA\u05E9\u05DC\u05D5\u05DE\u05D9\u05DD \u05DE\u05E2\u05D5\u05D1\u05D3\u05D9\u05DD \u05E9\u05D1\u05D5\u05E2\u05D9\u05EA (\u05DB\u05DC \u05D9\u05D5\u05DD \u05E8\u05D0\u05E9\u05D5\u05DF) \u05DC\u05D7\u05E9\u05D1\u05D5\u05DF \u05D4\u05D1\u05E0\u05E7 \u05D4\u05E8\u05E9\u05D5\u05DD. \u05E1\u05E3 \u05DE\u05D9\u05E0\u05D9\u05DE\u05D5\u05DD: 50 \u05E9"\u05D7.' },
    ...
    generalFaq: [
      { q: '\u05D4\u05D0\u05DD ShaPop \u05D6\u05DE\u05D9\u05E0\u05D4 \u05DE\u05D7\u05D5\u05E5 \u05DC\u05D9\u05E9\u05E8\u05D0\u05DC?', a: '\u05DB\u05E8\u05D2\u05E2 ShaPop \u05DE\u05DE\u05D5\u05E7\u05D3\u05EA \u05D1\u05E9\u05D5\u05E7 \u05D4\u05D9\u05E9\u05E8\u05D0\u05DC\u05D9. \u05D0\u05E0\u05D5 \u05DE\u05EA\u05DB\u05E0\u05E0\u05D9\u05DD \u05DC\u05D4\u05EA\u05E8\u05D7\u05D1 \u05DC\u05DE\u05D3\u05D9\u05E0\u05D5\u05EA \u05E0\u05D5\u05E1\u05E4\u05D5\u05EA.' },
  ...
  fr: {
    ...
    buyerFaq: [
      ...
      { q: 'Puis-je retourner un article ?', a: 'Oui ! Vous disposez de 14 jours après la livraison pour demander un retour, conformément à la loi israélienne sur la protection des consommateurs. Les articles doivent être dans leur état d\'origine. Contactez le vendeur via l\'application pour initier un retour.' },
      { q: 'Combien de temps dure la livraison ?', a: 'Les délais de livraison dépendent du vendeur. La plupart des vendeurs en Israël expédient sous 1 à 3 jours ouvrés. Le délai de livraison estimé est affiché avant l\'achat.' },
    ...
    sellerFaq: [
      ...
      { q: 'Quels sont les frais pour les vendeurs ?', a: 'ShaPop prélève une petite commission sur les ventes effectuées. Le taux exact dépend de votre niveau de vendeur. Les nouveaux vendeurs bénéficient d\'un taux d\'introduction compétitif. Consultez votre Tableau de bord vendeur pour plus de détails.' },
      { q: 'Quand suis-je payé ?', a: 'Les versements sont traités chaque semaine (tous les dimanches) sur votre compte bancaire enregistré. Le seuil minimum de versement est de 50 ILS.' },
    ...
    generalFaq: [
      { q: 'ShaPop est-il disponible en dehors d\'Israël ?', a: 'Actuellement, ShaPop se concentre sur le marché israélien. Nous prévoyons de nous étendre à d\'autres pays à l\'avenir.' },
      ...
      { q: 'ShaPop est-il gratuit ?', a: 'Oui ! L\'application est gratuite à télécharger et à utiliser. Les acheteurs ne paient aucun frais. Les vendeurs paient une petite commission uniquement sur les ventes effectuées.' },
    ] as FaqItem[],
  },
  es: {
    ...
    buyerFaq: [
      ...
      { q: 'Puedo devolver un articulo?', a: 'Si, tienes 14 dias desde la entrega para solicitar una devolucion conforme a la ley israeli.' },
      { q: 'Cuanto tarda el envio?', a: 'Depende del vendedor. La mayoria en Israel envian en 1-3 dias habiles.' },
    ...
    sellerFaq: [
      ...
      { q: 'Cuales son las comisiones?', a: 'ShaPop cobra una pequena comision sobre ventas completadas. Revisa tu Panel de Vendedor para detalles.' },
      { q: 'Cuando recibo mi pago?', a: 'Los pagos se procesan semanalmente (cada domingo). Minimo: 50 ILS.' },
    ...
    generalFaq: [
      { q: 'Esta ShaPop disponible fuera de Israel?', a: 'Actualmente nos enfocamos en Israel. Planeamos expandirnos pronto.' },
      ...
      { q: 'Es gratis ShaPop?', a: 'Si! La app es gratuita. Compradores no pagan comisiones. Vendedores pagan solo sobre ventas completadas.' },
    ] as FaqItem[],
  },
}
