...
test.describe('Responsive — Content layout at various widths', () => {
  // Test a very narrow viewport (320px — older/small devices)
  ...
  test('form inputs at 320px are fully visible and usable', async ({ page }) => {
    ...
    expect(box).not.toBeNull()
    // Input should not extend beyond viewport width (320px)
    expect(box!.x + box!.width).toBeLessThanOrEqual(320)
    // Input should have reasonable width (at least 200px for usability)
